        ...
        <div className="flex items-center gap-4">
          {token ? (
            ...
            <button
              ...
              className="hidden px-8 py-3 font-light text-white transition duration-300 ease-in-out delay-150 bg-purple-500 rounded-full md:block hover:-translate-y-1 hover:scale-110 hover:bg-purple-700 hover:shadow-lg"
            >
              Create Eccount
            </button>
          )}
          <AiOutlineMenuFold
            ...
            className="w-auto h-7 md:hidden"
          />
          {/* mobile menu -----------------------*/}
          <div
            className={`${
              showMenu ? "flex w-full" : "h-0 w-0"
